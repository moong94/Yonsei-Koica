...
<div id="bo_list" class="ety-mt-qa">
    ...
    <div class="tbl_head01 tbl_wrap mpage">
        ...
        <tr>
            ...
            <td class="td_stat"><span class=" <?php echo ($list[$i]['qa_status'] ? 'txt_done_mobile' : 'txt_rdy_mobile'); ?>"><?php echo ($list[$i]['qa_status'] ? '<i class="fa fa-check-circle" aria-hidden="true"></i> 답변완료' : '<i class="fa fa-times-circle" aria-hidden="true"></i> 답변대기'); ?></span></td>
        </tr>
        <?php
        }
        ?>
